  ...
  return (
    <section className="flex relative flex-col gap-4 justify-center items-center pb-24 w-full">
      ...
      <div className="flex flex-col gap-4 justify-center items-center px-6 pt-28 pb-12 lg:pb-16 lg:gap-8 md:pt-40 lg:pt-40">
        <h1 className="text-4xl w-[90%] md:text-5xl lg:text-7xl font-bold tracking-[-0.020em] text-center leading-[0.9] text-colored">
          <span className="text-colored-tertiary">{t("the")}</span>{" "}
          {t("assistant")}{" "}
          <span className="text-colored-tertiary">{t("finicial")}</span>
        </h1>
