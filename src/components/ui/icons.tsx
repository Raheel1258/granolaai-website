  ...
  <div className="flex justify-center items-center">
    {[...Array(12)].map((_, i) => (
      <div
        key={i}
        className="absolute"
        style={{ transform: `rotate(${i * 30}deg) translateY(-1.5rem)` }}
      >
        <svg
          width="10"
          height="10"
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M5 0l1.545 3.13L10 3.635 7.5 6.07l.59 3.44L5 7.865 1.91 9.51l.59-3.44L0 3.635l3.455-.505z" />
        </svg>
      </div>
    ))}
  </div>
...
export const ThumbsUpIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const CheckBadgeIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
