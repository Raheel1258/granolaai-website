import { PolicyCard } from "./PrivacySection";
...
export const TermsSection = () => {
  const terms = [
    {
      ...
      url: "https://go.granola.so/platform-tos",
      icon: (
        <svg
    ...
    },
    {
      ...
      url: "https://go.granola.so/user-tos",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="text-fuchsia-500 size-6"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      ...
      url: "https://go.granola.so/application-tos",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
  ...
  return (
    <div className="grid gap-4 pt-8 mt-6 border-t border-teal-700/10 md:grid-cols-4">
      <h2 className="text-4xl font-semibold text-colored">Terms</h2>
